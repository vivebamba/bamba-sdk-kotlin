...
class CustomerApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun customerCustomerIdServiceGet(customerId: kotlin.Int) : Service {
        val localVariableConfig = customerCustomerIdServiceGetRequestConfig(customerId = customerId)
    ...
    /**
    * To obtain the request config of the operation customerCustomerIdServiceGet
    *
    * @param customerId Bamba customer unique identifier 
    * @return RequestConfig
    */
    fun customerCustomerIdServiceGetRequestConfig(customerId: kotlin.Int) : RequestConfig {
        ...
        val localVariableConfig = RequestConfig(
            ...
            path = "/customer/{customerId}/service".replace("{"+"customerId"+"}", "$customerId"),
