...
class CustomerApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun customerCustomerIdServicesGet(customerId: java.util.UUID) : kotlin.collections.List<kotlin.Any> {
    ...
    */
    fun customerCustomerIdServicesGetRequestConfig(customerId: java.util.UUID) : RequestConfig {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun customerCustomerIdServicesServiceIdCancelPut(customerId: java.util.UUID, serviceId: java.util.UUID) : CancellationResponse {
    ...
    * @return RequestConfig
    */
    fun customerCustomerIdServicesServiceIdCancelPutRequestConfig(customerId: java.util.UUID, serviceId: java.util.UUID) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
