...
class CustomerApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun customerCustomerIdServicesSkuCancelGet(customerId: kotlin.String, sku: kotlin.String) : Subscription {
        val localVariableConfig = customerCustomerIdServicesSkuCancelGetRequestConfig(customerId = customerId, sku = sku)
    ...
    /**
    * To obtain the request config of the operation customerCustomerIdServicesSkuCancelGet
    *
    * @param customerId Bamba customer unique identifier 
    * @param sku Service sku 
    * @return RequestConfig
    */
    fun customerCustomerIdServicesSkuCancelGetRequestConfig(customerId: kotlin.String, sku: kotlin.String) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
